...
Source Database       : js_20230117_2668

Target Server Type    : MYSQL
Target Server Version : 50725
File Encoding         : 65001

Date: 2023-02-26 01:46:19
*/
...
(
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='学生管理';

-- ----------------------------
-- Records of app_user
-- ----------------------------
INSERT INTO `app_user`
VALUES ('1', '20191122', '1', '张三', '1', '15802030203', '2', '2', '2', '1');
INSERT INTO `app_user`
VALUES ('8', '20191234', '1', '李德生', '1', '18977889111', '2', '1', '1', '4');
INSERT INTO `app_user`
VALUES ('9', '20201234', '1', '张珊珊', '2', '18912345698', '1', '2', '2', '1');
...
(
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='课程管理';
...
VALUES ('1', '计算机基础与应用', '4', '2.00',
        ...
        '2023-02-25 23:02:02');
INSERT INTO `course_manage`
VALUES ('2', 'C语言程序设计', '4', '2.00', 'C语言程序设计', '2023-02-25 23:03:38');
INSERT INTO `course_manage`
VALUES ('3', '计算机组成原理', '2', '1.00', '计算机组成原理', '2023-02-25 23:04:24');
INSERT INTO `course_manage`
VALUES ('4', '微机原理及汇编语言', '2', '1.00', '微机原理及汇编语言', '2023-02-25 23:04:54');
INSERT INTO `course_manage`
VALUES ('5', '分布式系统', '2', '1.00', '分布式系统', '2023-02-25 23:05:05');
INSERT INTO `course_manage`
VALUES ('6', '软件项目管理', '2', '1.00', '软件项目管理', '2023-02-25 23:05:14');
INSERT INTO `course_manage`
VALUES ('7', 'Oracle数据库系统', '3', '1.50', 'Oracle数据库系统', '2023-02-25 23:05:23');
INSERT INTO `course_manage`
VALUES ('8', '高级语言程序设计', '4', '2.00', '高级语言程序设计', '2023-02-25 23:05:37');
INSERT INTO `course_manage`
VALUES ('9', '面向对象程序设计', '3', '1.50', '面向对象程序设计', '2023-02-25 23:05:52');
...
(
  ...
  `create_time` varchar(20) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='成绩管理';

-- ----------------------------
-- Records of result_manage
-- ----------------------------
INSERT INTO `result_manage`
VALUES ('1', '1', '5', '62', '1.00', '1', '8', '1', '1', '2023-02-25 23:16:42');
INSERT INTO `result_manage`
VALUES ('2', '2', '1', '86', '3.50', '2', '8', '1', '1', '2023-02-25 23:19:11');
INSERT INTO `result_manage`
VALUES ('3', '1', '2', '88', '3.50', '2', '8', '1', '1', '2023-02-25 23:19:49');
INSERT INTO `result_manage`
VALUES ('4', '2', '6', '90', '4.00', '2', '8', '1', '1', '2023-02-25 23:22:17');
INSERT INTO `result_manage`
VALUES ('5', '1', '7', '48', '0.00', '2', '8', '1', '1', '2023-02-25 23:22:34');
INSERT INTO `result_manage`
VALUES ('6', '3', '8', '75', '2.50', '1', '8', '1', '1', '2023-02-25 23:23:01');
INSERT INTO `result_manage`
VALUES ('7', '3', '4', '89', '3.50', '2', '8', '1', '1', '2023-02-26 01:44:08');
...
(
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='学年管理';
...
(
    ...
    `create_time`       varchar(20)   DEFAULT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='违纪处分管理';
