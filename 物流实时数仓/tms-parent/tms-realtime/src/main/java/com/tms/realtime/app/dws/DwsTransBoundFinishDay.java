...
import com.tms.realtime.beans.DwdTransDispatchDetailBean;
import com.tms.realtime.beans.DwsTransBoundFinishDayBean;
 ...
 * 物流域转运完成统计
 * 需要启动的进程
 *      zk、kafka、hdfs、clickhouse、OdsApp、DwdOrderRelevantApp、DwsTransBoundFinishDay
 */
