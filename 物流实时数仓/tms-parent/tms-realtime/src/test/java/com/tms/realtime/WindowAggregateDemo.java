...
public class WindowAggregateDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> sensorDS = env
                ...
                .map(new MapFunction<String, WaterSensor>() {
                    ...
                    public WaterSensor map(String value) throws Exception {
                        ...
                        return new WaterSensor(s.get(0), Long.valueOf(s.get(1)), Integer.valueOf(s.get(2)));
                    }
                });
        ...
        WatermarkStrategy<WaterSensor> objectWatermarkStrategy = WatermarkStrategy
        ...
        SingleOutputStreamOperator<String> aggregate = sensorWS.aggregate(
                ...
                new AggregateFunction<WaterSensor, Integer, String>() {
                    ...
                    /**
                     * 聚合逻辑
                     * @param value        这一次要累加的数据
                     * @param accumulator  上一次的累加结果
                     * @return
                     */
                    @Override
