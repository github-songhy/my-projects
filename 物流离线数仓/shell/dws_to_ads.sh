...
case $1 in
"all")
	/export/server/hive/bin/hive -e "use tms;${ads_city_stats_sql}${ads_driver_stats_sql}${ads_express_city_stats_sql}${ads_express_org_stats_sql}${ads_express_province_stats_sql}${ads_express_stats_sql}${ads_line_stats_sql}${ads_order_cargo_type_stats_sql}${ads_order_stats_sql}${ads_org_stats_sql}${ads_shift_stats_sql}${ads_trans_order_stats_sql}${ads_trans_order_stats_td_sql}${ads_trans_stats_sql}${ads_truck_stats_sql}"
;;
"ads_city_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_city_stats_sql}"
;;
"ads_driver_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_driver_stats_sql}"
;;
"ads_express_city_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_express_city_stats_sql}"
;;
"ads_express_org_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_express_org_stats_sql}"
;;
"ads_express_province_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_express_province_stats_sql}"
;;
"ads_express_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_express_stats_sql}"
;;
"ads_line_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_line_stats_sql}"
;;
"ads_order_cargo_type_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_order_cargo_type_stats_sql}"
;;
"ads_order_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_order_stats_sql}"
;;
"ads_org_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_org_stats_sql}"
;;
"ads_shift_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_shift_stats_sql}"
;;
"ads_trans_order_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_trans_order_stats_sql}"
;;
"ads_trans_order_stats_td")
    /export/server/hive/bin/hive -e "use tms;${ads_trans_order_stats_td_sql}"
;;
"ads_trans_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_trans_stats_sql}"
;;
"ads_truck_stats")
    /export/server/hive/bin/hive -e "use tms;${ads_truck_stats_sql}"
;;
*)
	echo "表名输入错误..."
;;
