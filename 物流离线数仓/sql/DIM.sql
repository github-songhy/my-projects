...
create external table dim_complex_full(
  ...
  stored as orc
  location '/hive/warehouse/tms.db/dim/dim_complex_full'
...
create external table dim_organ_full(
  ...
  partitioned by (`dt` string comment '统计日期')
  stored as orc
  location '/hive/warehouse/tms.db/dim/dim_organ_full'
  tblproperties('orc.compress'='snappy');
...
create external table dim_region_full(
  ...
  `short_name` string COMMENT '简称'
    ...
    partitioned by (`dt` string comment '统计日期')
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_region_full'
    tblproperties('orc.compress'='snappy');
...
create external table dim_express_courier_full(
  ...
  partitioned by (`dt` string comment '统计日期')
  stored as orc
  location '/hive/warehouse/tms.db/dim/dim_express_courier_full'
  tblproperties('orc.compress'='snappy');
...
create external table dim_shift_full(
  ...
  `pair_shift_id` bigint COMMENT '配对班次(同一辆车一去一回的另一班次)'
    ...
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_shift_full'
    tblproperties('orc.compress'='snappy');
...
create external table dim_truck_driver_full(
  ...
  `is_enabled` tinyint COMMENT '状态 0：禁用 1：正常'
    ...
    partitioned by (`dt` string comment '统计日期')
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_truck_driver_full'
    tblproperties('orc.compress'='snappy');
...
create external table dim_truck_full(
  ...
  `is_enabled` tinyint COMMENT '状态 0：禁用 1：正常'
    ...
    partitioned by (`dt` string comment '统计日期')
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_truck_full'
    tblproperties('orc.compress'='snappy');
...
create external table dim_user_zip(
  ...
  `end_date` string COMMENT '结束日期'
    ...
    partitioned by (`dt` string comment '统计日期')
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_user_zip'
    tblproperties('orc.compress'='snappy');
...
create external table dim_user_address_zip(
  ...
  `end_date` string COMMENT '结束日期'
    ...
    partitioned by (`dt` string comment '统计日期')
    stored as orc
    location '/hive/warehouse/tms.db/dim/dim_user_address_zip'
    tblproperties('orc.compress'='snappy');