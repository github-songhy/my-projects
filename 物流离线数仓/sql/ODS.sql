...
create external table ods_order_info_inc(
  ...
  `ts` bigint comment '时间戳'
	...
	location '/hive/warehouse/tms.db/ods/ods_order_info_inc';
...
create external table ods_order_cargo_inc(
	...
	partitioned by (`dt` string comment '统计日期')
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'
	location '/hive/warehouse/tms.db/ods/ods_order_cargo_inc';
...
create external table ods_transport_task_inc(
	...
	partitioned by (`dt` string comment '统计日期')
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'
	location '/hive/warehouse/tms.db/ods/ods_transport_task_inc';
...
create external table ods_order_org_bound_inc(
	...
	partitioned by (`dt` string comment '统计日期')
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'
	location '/hive/warehouse/tms.db/ods/ods_order_org_bound_inc';
...
create external table ods_user_info_inc(
	...
	partitioned by (`dt` string comment '统计日期')
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'
	location '/hive/warehouse/tms.db/ods/ods_user_info_inc';
...
create external table ods_user_address_inc(
	...
	partitioned by (`dt` string comment '统计日期')
	ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.JsonSerDe'
	location '/hive/warehouse/tms.db/ods/ods_user_address_inc';
...
create external table ods_base_complex_full(
	...
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_base_complex_full';
...
create external table ods_base_dic_full(
    ...
    ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
    NULL DEFINED AS ''
    location '/hive/warehouse/tms.db/ods/ods_base_dic_full/';
...
create external table ods_base_region_info_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_base_region_info_full';
...
create external table ods_base_organ_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_base_organ_full';
...
create external table ods_express_courier_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_express_courier_full';
...
create external table ods_express_courier_complex_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_express_courier_complex_full';
...
create external table ods_employee_info_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_employee_info_full';
...
create external table ods_line_base_shift_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_line_base_shift_full';
...
create external table ods_line_base_info_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_line_base_info_full';
...
create external table ods_truck_driver_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_truck_driver_full';
...
create external table ods_truck_info_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_truck_info_full';
...
create external table ods_truck_model_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_truck_model_full';
...
create external table ods_truck_team_full(
	...
	row format delimited fields terminated by '\t'
	null defined as ''
	location '/hive/warehouse/tms.db/ods/ods_truck_team_full';
