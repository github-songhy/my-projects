...
public class WuzifenpeiController {
    ...
    public R page(@RequestParam Map<String, Object> params,WuzifenpeiEntity wuzifenpei, 
		...
		if(tableName.equals("danwei")) {
			wuzifenpei.setDanweizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("dpry")) {
			wuzifenpei.setDpryzhanghao((String)request.getSession().getAttribute("username"));
		}
