	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">单位账号</label>
							<input  name="danweizhanghao" placeholder="单位账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">单位负责人姓名</label>
							<input  name="dwfzrxingming" placeholder="单位负责人姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="danweidizhi" placeholder="单位地址" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "danwei/register";
				$.ajax({ 
					type: "POST",
					url: url,
