		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑单位反馈</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑单位反馈</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">单位反馈信息</h3>
									...
									<div class="form-group col-md-6">
										...
										<div id="fankuishijianDate" class="input-append date form_datetime">
											...
											<div class="form-group  col-md-12" >
												<label>反馈内容</label>
												<div><div class="upload"><input id="fankuineirongupload" name="file" type="file">插入图片</div>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "danweifankui/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("danweifankui/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("danweifankui/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
