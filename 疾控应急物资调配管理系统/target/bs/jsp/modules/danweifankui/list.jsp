...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">单位反馈管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>单位反馈管理</span></li>
								<li class="breadcrumb-item active"><span>单位反馈列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">单位反馈列表</h3>
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										单位账号
									</label>
									<input type="text" id="danweizhanghaoSearch" class="form-control form-control-sm" placeholder="请输入单位账号" aria-controls="tableId">
									<label>
										单位负责人
									</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#danweizhanghaoSearch').val() != null && $('#danweizhanghaoSearch').val() != ''){
				searchForm.danweizhanghao ="%" +  $('#danweizhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("danweifankui/page","GET",{
				page: pageIndex,
				limit: pageSize,
                sfsh: searchForm.sfsh,
				sort: sortColumn,
				order: sortOrder,
				danweizhanghao : searchForm.danweizhanghao,
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("danweifankui/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("danweifankui/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("danweifankui/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"danweifankui");
