						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="xuqiuwuzi" name="xuqiuwuzi" class="form-control" v-model="ruleForm.xuqiuwuzi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>需求数量</label>

									<input id="xuqiushuliang" name="xuqiushuliang" class="form-control" v-model="ruleForm.xuqiushuliang" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>申请时间</label>
