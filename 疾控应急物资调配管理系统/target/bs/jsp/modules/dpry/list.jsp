...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">调配人员管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>调配人员管理</span></li>
								<li class="breadcrumb-item active"><span>调配人员列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">调配人员列表</h3>
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										调配人员账号
									</label>
									<input type="text" id="dpryzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入调配人员账号" aria-controls="tableId">
									<label>
										调配人员姓名
									</label>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#dpryzhanghaoSearch').val() != null && $('#dpryzhanghaoSearch').val() != ''){
				searchForm.dpryzhanghao ="%" +  $('#dpryzhanghaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("dpry/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				dpryzhanghao : searchForm.dpryzhanghao,
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("dpry/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"dpry");
